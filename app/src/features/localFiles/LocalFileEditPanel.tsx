...
>
type LocalEditApplyResult = Awaited<ReturnType<LocalEditsBridge['apply']>>
type LocalEditAppliedFile = LocalEditApplyResult['files'][number]
...
async function reconcileCatalogFiles(files: LocalEditAppliedFile[]) {
...
function catalogFailureMessage(count: number) {
